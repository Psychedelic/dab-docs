...
Since the NFT list also follows the DAB Registry standard, we can interact with it's base methods through the use of the `NFTRegistry` object that DAB-js provides.  
